...
public class ProductViewResponseData implements Serializable
{
    ...
    @SerializedName("actual_product_price")
    @Expose
    ...
    public Integer getActualProductPrice() {
        return actualProductPrice;
    }

    public void setActualProductPrice(Integer actualProductPrice) {
